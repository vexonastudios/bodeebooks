...
const appRoute = /^\/(?:account|activate|dashboard|admin|support|install|sign-in|sign-up)(?:\/|$)|^\/download\/windows(?:\/|$)/;
const pageRoute = /^\/(?:account|activate|dashboard|admin|support|install)\/?$|^\/(?:sign-in|sign-up)(?:\/|$)|^\/download\/windows\/?$/;
